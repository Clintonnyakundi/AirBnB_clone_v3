...
class TestDBStorage(unittest.TestCase):
    ...
    def test_get(self):
        ...
        new_state.save()
        new_user = User(email="queenskisivuli@gmail.com", password="password")
        new_user.save()
        self.assertIs(new_state, models.storage.get("State", new_state.id))
        self.assertIs(None, models.storage.get("State", "Ibiza"))
        self.assertIs(None, models.storage.get("Ibiza", "Ibiza"))
    ...
    def test_count(self):
        ...
        self.assertEqual(models.storage.count("Ibiza"), 0)
        new_state = State(name="Florida")
        new_state.save()
        new_user = User(email="mokayaclinton34@gmail.com", password="password")
        new_user.save()
